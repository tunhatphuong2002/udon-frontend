...
const TransferedSuccessModal = create<{ amount: number; ticker: string }>(({ amount, ticker }) => {
...
export const useTransferedSuccessModal = () => {
  const modal = useModal(TransferedSuccessModal);
