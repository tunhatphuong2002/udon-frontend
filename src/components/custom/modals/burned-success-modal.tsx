...
const BurnedSuccessModal = create<{ amount: number; ticker: string }>(({ amount, ticker }) => {
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <div>
          <p className="text-center text-xs text-muted-foreground">You have successfully burned</p>
...
export const useBurnedSuccessModal = () => {
  const modal = useModal(BurnedSuccessModal);
