...
const linkSocial = [
  {
    title: 'Twitter',
    url: 'https://twitter.com/udonfinance',
    icon: (
      <SocialIcon>
  ...
  {
    title: 'GitHub',
    url: 'https://github.com/udonfinance',
    icon: (
      <SocialIcon>
...
export const Footer: React.FC = () => {
  return (
    <footer className="relative flex flex-col w-full max-md:max-w-full h-[450px] bg-black rounded-tr-[60px]">
      <GridPattern
        width={115}
        height={115}
        className={cn('[mask-image:linear-gradient(to_top,white,white,transparent)]')}
      />
      <div className="flex flex-grow-[0.8] relative top-[-60px]">
      ...
      <div className="flex flex-grow-[0.2] flex-row text-white items-center justify-between px-8">
        <Typography>@2025 Udon Finance. All rights reserved.</Typography>
        <div className="flex flex-col w-[30%] gap-6 items-end">
