...
export const WithdrawDialog: React.FC<WithdrawDialogProps> = ({
  ...
  const maxWithdrawAmount =
    reserve.currentATokenBalance > maxAmount ? maxAmount : reserve.currentATokenBalance;

  console.log('maxAmount', maxAmount);
  console.log('reserve.currentATokenTotalSupply', reserve.currentATokenTotalSupply);
      ...
      <DialogContent className="sm:max-w-[425px] rounded-xl">
        <DialogHeader>
          <div className="flex justify-between items-center">
            <DialogTitle className="text-2xl font-semibold">Withdraw {reserve.symbol}</DialogTitle>
          </div>
        </DialogHeader>
                ...
                <Typography className="flex items-center gap-1">
                  ...
                  <Tooltip delayDuration={100}>
                    ...
                    <TooltipContent side="bottom">
                      <p>Your supply balance after this withdrawal</p>
                    </TooltipContent>
                  </Tooltip>
                </Typography>
              ...
              <div className="flex justify-between items-center">
                <Typography className="flex items-center gap-1">
                  ...
                  <Tooltip delayDuration={100}>
                    ...
                    <TooltipContent side="bottom">
                      <p>Amount you will receive after deducting 1% protocol fee</p>
                    </TooltipContent>
                  </Tooltip>
                </Typography>
